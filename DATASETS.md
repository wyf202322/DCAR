...
Datasets list:
- [Caltech101](https://github.com/muzairkhattak/multimodal-prompt-learning/blob/main/docs/DATASETS.md#caltech101)
- [OxfordPets](https://github.com/muzairkhattak/multimodal-prompt-learning/blob/main/docs/DATASETS.md#oxfordpets)
- [StanfordCars](https://github.com/muzairkhattak/multimodal-prompt-learning/blob/main/docs/DATASETS.md#stanfordcars)
- [Flowers102](https://github.com/muzairkhattak/multimodal-prompt-learning/blob/main/docs/DATASETS.md#flowers102)
- [Food101](https://github.com/muzairkhattak/multimodal-prompt-learning/blob/main/docs/DATASETS.md#food101)
- [FGVCAircraft](https://github.com/muzairkhattak/multimodal-prompt-learning/blob/main/docs/DATASETS.md#fgvcaircraft)
- [SUN397](https://github.com/muzairkhattak/multimodal-prompt-learning/blob/main/docs/DATASETS.md#sun397)
- [DTD](https://github.com/muzairkhattak/multimodal-prompt-learning/blob/main/docs/DATASETS.md#dtd)
- [UCF101](https://github.com/muzairkhattak/multimodal-prompt-learning/blob/main/docs/DATASETS.md#ucf101)

The instructions to prepare each dataset are detailed below. To ensure reproducibility and fair comparison for future work, we provide fixed train/val/test splits for all datasets. The fixed splits are either from the original datasets (if available) or created by us.
